...
public class prog extends java.lang.Object {
    ...
    public static void esperarintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_esperar_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void esperarintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int a = ((Number) JRargs[0]).intValue();
            {
                try {
                    // Begin Expr2
                    Thread.sleep(a);
    ...
    public static Op_ext.JRProxyOp JRget_op_esperar_intTovoid()
    {
        return op_esperar_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_esperar_intTovoid;
    static class ProcOp_intTovoid_implesperar extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implesperar(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.esperarintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.esperarintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_esperar_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implesperar(null));
        ...
        try    {
            {
                JRLoop1: while (true) {
                    // Begin Expr2
                    c1 = quiereentrar;
                    JRLoop0: while (c2 == quiereentrar) {
                        // Begin Expr2
                        c1 = restoproceso;
                        // Begin Expr2
                        System.out.println("consumidor espera");
                        // Begin Expr2
                        (new Cap_ext_(JRget_op_esperar_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {0});
                        // Begin Expr2
                        c1 = quiereentrar;
                    }
                    if (elemnt > -1) {
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_productor_voidTovoid, op_consumidor_voidTovoid, op_esperar_intTovoid);
    	this.JRcalled = true;
    }
