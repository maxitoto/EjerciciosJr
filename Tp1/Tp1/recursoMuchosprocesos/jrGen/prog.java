...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_estaescribiendo_voidTovoid()
    {
        return op_estaescribiendo_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_estaescribiendo_voidTovoid;
    ;
    static    {
        try    {
            op_estaescribiendo_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_estaescribiendo_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
    ...
    static void esperaintXintXintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_espera_intXintXintTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void esperaintXintXintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int t = ((Number) JRargs[0]).intValue();
            // GetMethod 1
            int id = ((Number) JRargs[1]).intValue();
            // GetMethod 1
            int LecOescr = ((Number) JRargs[2]).intValue();
            {
                try {
                    // Begin Expr2
    ...
    static Op_ext.JRProxyOp JRget_op_espera_intXintXintTovoid()
    {
        return op_espera_intXintXintTovoid;
    }
    
    public static Op_ext.JRProxyOp op_espera_intXintXintTovoid;
    static class ProcOp_intXintXintTovoid_implespera extends ProcOp_ext_impl
    {
        public ProcOp_intXintXintTovoid_implespera(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.esperaintXintXintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.esperaintXintXintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_espera_intXintXintTovoid = new Op_ext_.JRProxyOp(new ProcOp_intXintXintTovoid_implespera(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_lector_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_impllector(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.lectorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.lectorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static void lectorintTovoid(java.lang.Object [] JRargs) {
    ...
    private static void lectorintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop0: while (true) {
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_espera_intXintXintTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {5000, i, 2});
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_estaescribiendo_voidTovoid().recv();
                    ...
                    JRget_op_estaescribiendo_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
                    System.out.println("lector " + i + " lee buffer: " + buffersimple);
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_estaescribiendo_voidTovoid().recv();
                        jrvm.ariseAndReceive();
    ...
    static Op_ext.JRProxyOp JRget_op_escritor_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implescritor(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.escritorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.escritorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static void escritorintTovoid(java.lang.Object [] JRargs) {
    ...
    private static void escritorintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_espera_intXintXintTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {5000, i, 1});
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_escritor_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                    ...
                    // Begin Expr2
                    buffersimple = ((int)(Math.random() * 100 / Math.random()));
                    // Begin Expr2
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_escritor_intTovoid, op_lector_intTovoid, op_espera_intXintXintTovoid, op_escritor_voidTovoid, op_estaescribiendo_voidTovoid);
    	this.JRcalled = true;
    }
