...
public class prog extends java.lang.Object {
    ...
    static int[] buffer;
    static Op_ext.JRProxyOp JRget_op_sp_voidTovoid()
    {
        return op_sp_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_sp_voidTovoid;
    ;
    static    {
        try    {
            op_sp_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_sp_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_sc_voidTovoid()
    {
        return op_sc_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_sc_voidTovoid;
    ;
    static    {
        try    {
            op_sc_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_sc_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
...
return null;
    ...
    public Op_ext.JRProxyOp JRget_op_productor_intTovoid()
    {
        return op_productor_intTovoid;
    }
    
    public Op_ext.JRProxyOp op_productor_intTovoid;
    class ProcOp_intTovoid_implproductor extends ProcOp_ext_impl
    {
        prog thisarg;
        ...
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                thisarg.productorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.productorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    public void productorintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_productor_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void productorintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop0: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_sc_voidTovoid().recv();
                    ...
                    JRget_op_sp_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_espera_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {12000});
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    public Op_ext.JRProxyOp JRget_op_consumidor_intTovoid()
    {
        return op_consumidor_intTovoid;
    }
    
    public Op_ext.JRProxyOp op_consumidor_intTovoid;
    class ProcOp_intTovoid_implconsumidor extends ProcOp_ext_impl
    {
        prog thisarg;
        ...
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                thisarg.consumidorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.consumidorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    public void consumidorintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_consumidor_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void consumidorintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_sp_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    JRget_op_sc_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_espera_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {12000});
                }
            }
    ...
    protected void JRinit() {
    	...
    	try {
    	op_consumidor_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implconsumidor(this));
    	op_productor_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implproductor(this));
    	} catch (Exception JRe)
    	{ throw new jrRuntimeError(JRe.toString()); }
    	jrresref = new JRprog(op_consumidor_intTovoid, op_productor_intTovoid, op_espera_intTovoid, op_sc_voidTovoid, op_sp_voidTovoid);
    	this.JRcalled = true;
    }
