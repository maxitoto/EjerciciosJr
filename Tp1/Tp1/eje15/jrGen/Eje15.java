...
public class Eje15 extends java.lang.Object {
    { JRinit(); }
    ...
    private static Op_ext.JRProxyOp JRget_op_p1_voidTovoid()
    {
    ...
    {
        public ProcOp_voidTovoid_implp1(Eje15 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Eje15.p1voidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Eje15.p1voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void p1voidTovoid(java.lang.Object [] JRargs) {
    ...
    private static void p1voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop0: while (!Eje15.puerta & Eje15.interacion < 5) {
                    if (Eje15.puerta) {
                        // Begin Expr2
                        Eje15.puerta = false;
                        // Begin Expr2
    ...
    private static Op_ext.JRProxyOp JRget_op_p2_voidTovoid()
    {
    ...
    {
        public ProcOp_voidTovoid_implp2(Eje15 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Eje15.p2voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Eje15.p2voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void p2voidTovoid(java.lang.Object [] JRargs) {
    ...
    private static void p2voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop1: while (!Eje15.puerta & Eje15.interacion < 5) {
                    if (Eje15.puerta) {
                        // Begin Expr2
                        Eje15.puerta = false;
                        // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_impldone(Eje15 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Eje15.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Eje15.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JREje15 jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JREje15(op_done_voidTovoid, op_p2_voidTovoid, op_p1_voidTovoid);
    	this.JRcalled = true;
    }
