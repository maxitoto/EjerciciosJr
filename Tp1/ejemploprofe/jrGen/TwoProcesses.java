...
public class TwoProcesses extends java.lang.Object {
    { JRinit(); }
    ...
    {
        public ProcOp_voidTovoid_implp1(TwoProcesses thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                TwoProcesses.p1voidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    TwoProcesses.p1voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    {
        public ProcOp_voidTovoid_implp2(TwoProcesses thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                TwoProcesses.p2voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    TwoProcesses.p2voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRTwoProcesses jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRTwoProcesses(op_p2_voidTovoid, op_p1_voidTovoid);
    	this.JRcalled = true;
    }
