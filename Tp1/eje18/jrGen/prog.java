...
public class prog extends java.lang.Object {
    ...
    static LinkedList boffer = new LinkedList();
        ...
        try    {
            {
                JRLoop0: while (true) {
                    try {
                        ...
                        // Begin Expr2
                        boffer.offer(recurso);
                        // Begin Expr2
                        System.out.println("productor insert " + recurso);
                        try {
                            // Begin Expr2
                            Thread.sleep(800);
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_consumidor_voidTovoid, op_productor_voidTovoid);
    	this.JRcalled = true;
    }
