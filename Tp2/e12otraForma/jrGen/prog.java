...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_B_voidTovoid()
    {
        return op_B_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_B_voidTovoid;
    ;
    static    {
        try    {
            op_B_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 2;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_B_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_R_voidTovoid()
    {
        return op_R_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_R_voidTovoid;
    ;
    static    {
        try    {
            op_R_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_R_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    static int rojas = 0;
    static Op_ext.JRProxyOp JRget_op_atacanBlanco_voidTovoid()
    {
        return op_atacanBlanco_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_atacanBlanco_voidTovoid;
    ;
    static    {
        try    {
            op_atacanBlanco_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_atacanBlanco_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_atacanRojo_voidTovoid()
    {
        return op_atacanRojo_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_atacanRojo_voidTovoid;
    ;
    static    {
        try    {
            op_atacanRojo_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_atacanRojo_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
        ...
        try    {
            {
                ...
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = JRget_op_atacanBlanco_voidTovoid().recv();
                ...
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = JRget_op_atacanRojo_voidTovoid().recv();
                    jrvm.ariseAndReceive();
                    if (recv_voidTovoid.retOp != null)
                        recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                }
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    if (vulnerable) {
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = JRget_op_B_voidTovoid().recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                        ...
                        if (blancas == 4) {
                            ...
                            JRget_op_atacanBlanco_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        } else {
                            JRget_op_B_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                            JRget_op_B_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                            JRget_op_mutexB_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        }
                    }
...
return null;
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop2: while (true) {
                    if (vulnerable) {
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = JRget_op_R_voidTovoid().recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                        ...
                        rojas += 1;
                        if (rojas == 2) {
                            JRget_op_R_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                            JRget_op_atacanRojo_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        } else {
                            JRget_op_R_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        }
                    }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_rojo_intTovoid, op_blanco_intTovoid, op_X_voidTovoid, op_atacanRojo_voidTovoid, op_atacanBlanco_voidTovoid, op_mutexB_voidTovoid, op_R_voidTovoid, op_B_voidTovoid, op_bloquear_voidTovoid);
    	this.JRcalled = true;
    }
