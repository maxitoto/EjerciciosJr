...
public class prog extends java.lang.Object {
    ...
    public static void wjavadotlangdotStringTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_w_javadotlangdotStringTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void wjavadotlangdotStringTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            String p = (String)JRargs[0];
            {
                JRLoop0: while (semaphore == 0) {
                    // Begin Expr2
    ...
    public static Op_ext.JRProxyOp JRget_op_w_javadotlangdotStringTovoid()
    {
        return op_w_javadotlangdotStringTovoid;
    }
    
    public static Op_ext.JRProxyOp op_w_javadotlangdotStringTovoid;
    static class ProcOp_javadotlangdotStringTovoid_implw extends ProcOp_ext_impl
    {
        public ProcOp_javadotlangdotStringTovoid_implw(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.wjavadotlangdotStringTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.wjavadotlangdotStringTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_w_javadotlangdotStringTovoid = new Op_ext_.JRProxyOp(new ProcOp_javadotlangdotStringTovoid_implw(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    
    public static void svoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_s_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void svoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // Begin Expr2
    ...
    public static Op_ext.JRProxyOp JRget_op_s_voidTovoid()
    {
        return op_s_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_s_voidTovoid;
    static class ProcOp_voidTovoid_impls extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_impls(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.svoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.svoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_s_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_impls(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    
    public static void esperaintTovoid(java.lang.Object [] JRargs) {
    ...
    public static Op_ext.JRProxyOp JRget_op_espera_intTovoid()
    {
...
return null;
    ...
    {
        public ProcOp_voidTovoid_implp1(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.p1voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.p1voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
        ...
        try    {
            {
                JRLoop1: while (true) {
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_w_javadotlangdotStringTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {"p1"});
                    // Begin Expr2
                    System.out.println("p1 en seccion critica");
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_s_voidTovoid(), "void")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_implp2(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.p2voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.p2voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
        ...
        try    {
            {
                JRLoop2: while (true) {
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_w_javadotlangdotStringTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {"p2"});
                    // Begin Expr2
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_p2_voidTovoid, op_p1_voidTovoid, op_espera_intTovoid, op_s_voidTovoid, op_w_javadotlangdotStringTovoid);
    	this.JRcalled = true;
    }
