...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_lineaLibre_voidTovoid()
    {
        return op_lineaLibre_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_lineaLibre_voidTovoid;
    ;
    static    {
        try    {
            op_lineaLibre_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = N;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_lineaLibre_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static // NUMBER 8
    Cap_ext_[] esperando = new // NUMBER 8
    Cap_ext_[3];
    static int[] RobotEsperando = new int[3];
    ...
    static {
        ...
        JRLoop1: for (int i = 0; i < 3; i++) {
            // Begin Expr2
            esperando[i] = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create((0))));
        }
        JRLoop2: for (int i = 0; i < 3; i++) {
            // Begin Expr2
            RobotEsperando[i] = -1;
        }
    }
...
return null;
    ...
    static Op_ext.JRProxyOp JRget_op_RColocador_voidTovoid()
    {
        return op_RColocador_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_RColocador_voidTovoid;
    static class ProcOp_voidTovoid_implRColocador extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implRColocador(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.RColocadorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.RColocadorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_RColocador_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implRColocador(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void RColocadorvoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_RColocador_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void RColocadorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // Begin Expr2
                System.out.println("Robot colocador comienza");
                int i = /*JR init for inni*/ 0;
                JRLoop5: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_lineaLibre_voidTovoid().recv();
                    ...
                    // Begin Expr2
                    i = 0;
                    JRLoop3: while (i < N - 1 & !(lineaProduccion[i] == -1)) {
                        // Begin Expr2
                        ++i;
                    }
                    {
                    ...
                    if (lineaProduccion[i] == -1) {
                        ...
                        JRLoop4: for (int j = 0; j < 3; j++) {
                            if (lineaProduccion[i] == RobotEsperando[j]) {
                                esperando[j].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                            }
                        }
                    }
    ...
    static {
        try {
            op_RColocador_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_RobotsEnsambladores_intTovoid()
    {
        return op_RobotsEnsambladores_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_RobotsEnsambladores_intTovoid;
    static class ProcOp_intTovoid_implRobotsEnsambladores extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implRobotsEnsambladores(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.RobotsEnsambladoresintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.RobotsEnsambladoresintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_RobotsEnsambladores_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implRobotsEnsambladores(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void RobotsEnsambladoresintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_RobotsEnsambladores_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void RobotsEnsambladoresintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                int A = /*JR init for inni*/ 0;
                JRLoop7: while (true) {
                    // Begin Expr2
                    A = 0;
                    JRLoop6: while (A < N - 1 & !(lineaProduccion[A] == i)) {
                        // Begin Expr2
                        ++A;
                    }
                    {
                    ...
                    if (lineaProduccion[A] == i) {
                        ...
                        // Begin Expr2
                        lineaProduccion[A] = -1;
                        JRget_op_lineaLibre_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    } else {
                        // Begin Expr2
                        RobotEsperando[i - 1] = i;
                        JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = esperando[i - 1].recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                        // Begin Expr2
                        RobotEsperando[i - 1] = -1;
                    }
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
    ...
    static {
        try {
            for (int i = 1; i < 4; i++) {
                op_RobotsEnsambladores_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_RobotsEnsambladores_intTovoid, op_RColocador_voidTovoid, op_espera_intTovoid, op_mutex_voidTovoid, op_lineaLibre_voidTovoid);
    	this.JRcalled = true;
    }
