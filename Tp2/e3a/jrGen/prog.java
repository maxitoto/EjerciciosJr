        ...
        try    {
            {
                JRLoop1: while (true) {
                    ...
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_espera_intTovoid(), "void")).call(jrvm.getTimestamp(), new java.lang.Object [] {100});
                    // Begin Expr2
                    sicnal(s2);
                }
            }
...
return null;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_p2_voidTovoid, op_p1_voidTovoid, op_espera_intTovoid);
    	this.JRcalled = true;
    }
