...
return null;
        ...
        try    {
            {
                ...
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = JRget_op_entraBlanco_voidTovoid().recv();
                    jrvm.ariseAndReceive();
                    if (recv_voidTovoid.retOp != null)
                        recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                }
                ...
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = JRget_op_entraRojo_voidTovoid().recv();
                    jrvm.ariseAndReceive();
                    if (recv_voidTovoid.retOp != null)
                        recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                }
    ...
    static Op_ext.JRProxyOp JRget_op_blancos_intTovoid()
    {
        return op_blancos_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_blancos_intTovoid;
    static class ProcOp_intTovoid_implblancos extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implblancos(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.blancosintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.blancosintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_blancos_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implblancos(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void blancosintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_blancos_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void blancosintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                if (vulnerable) {
                    JRget_op_entraBlanco_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                } else {
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
    ...
    static {
        try {
            for (int i = 0; i < n; i++) {
                op_blancos_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_rojos_intTovoid()
    {
        return op_rojos_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_rojos_intTovoid;
    static class ProcOp_intTovoid_implrojos extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implrojos(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.rojosintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.rojosintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_rojos_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implrojos(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void rojosintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_rojos_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void rojosintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                if (vulnerable) {
                    JRget_op_entraRojo_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                } else {
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
    ...
    static {
        try {
            for (int i = 0; i < m; i++) {
                op_rojos_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_rojos_intTovoid, op_blancos_intTovoid, op_x_voidTovoid, op_mutex_voidTovoid, op_entraRojo_voidTovoid, op_entraBlanco_voidTovoid);
    	this.JRcalled = true;
    }
