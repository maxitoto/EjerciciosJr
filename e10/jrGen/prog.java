...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_silla_voidTovoid()
    {
        return op_silla_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_silla_voidTovoid;
    ;
    static    {
        try    {
            op_silla_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_silla_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    static Op_ext.JRProxyOp JRget_op_cobrar_voidTovoid()
    {
        return op_cobrar_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_cobrar_voidTovoid;
    ;
    static    {
        try    {
            op_cobrar_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_cobrar_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_pagar_voidTovoid()
    {
        return op_pagar_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_pagar_voidTovoid;
    ;
    static    {
        try    {
            op_pagar_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_pagar_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_termino_voidTovoid()
    {
        return op_termino_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_termino_voidTovoid;
    ;
    static    {
        try    {
            op_termino_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_termino_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_barberia_voidTovoid()
    {
        return op_barberia_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_barberia_voidTovoid;
    static class ProcOp_voidTovoid_implbarberia extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implbarberia(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.barberiavoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.barberiavoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_barberia_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implbarberia(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void barberiavoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_barberia_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void barberiavoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop0: while (true) {
                    ...
                    if (cantEspearando == 0) {
                        ...
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = JRget_op_silla_voidTovoid().recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                        ...
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = JRget_op_termino_voidTovoid().recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                    ...
                    // Begin Expr2
                    System.out.println("Corto el cabello");
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_pagar_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    JRget_op_cobrar_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
    ...
    static {
        try {
            op_barberia_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_cliente_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implcliente(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.clienteintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.clienteintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static void clienteintTovoid(java.lang.Object [] JRargs) {
    ...
    private static void clienteintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                JRget_op_silla_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                // Begin Expr2
                ...
                cantEspearando -= 1;
                JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                JRget_op_pagar_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = JRget_op_cobrar_voidTovoid().recv();
                    jrvm.ariseAndReceive();
                    if (recv_voidTovoid.retOp != null)
                        recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                }
                ...
                JRget_op_termino_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                // Return
                { if (retOp != null)
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_cliente_intTovoid, op_barberia_voidTovoid, op_termino_voidTovoid, op_pagar_voidTovoid, op_cobrar_voidTovoid, op_espera_voidTovoid, op_silla_voidTovoid, op_mutex_voidTovoid);
    	this.JRcalled = true;
    }
