...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_puedoConsumir_charTovoid()
    {
        return op_puedoConsumir_charTovoid;
    }
    
    public static Op_ext.JRProxyOp op_puedoConsumir_charTovoid;
    ;
    static    {
        try    {
            op_puedoConsumir_charTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_puedoProducir_charTovoid()
    {
        return op_puedoProducir_charTovoid;
    }
    
    public static Op_ext.JRProxyOp op_puedoProducir_charTovoid;
    ;
    static    {
        try    {
            op_puedoProducir_charTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    static {
        ...
        JRLoop0: for (int i = 0; i < longBuffer; i++) {
            JRget_op_puedoProducir_charTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {'\000'});
        }
        // Begin Expr2
        System.out.println("Buzon listo\n");
    }
    static Op_ext.JRProxyOp JRget_op_Producer_intTovoid()
    {
        return op_Producer_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_Producer_intTovoid;
    static class ProcOp_intTovoid_implProducer extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implProducer(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.ProducerintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.ProducerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_Producer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implProducer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void ProducerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Producer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void ProducerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    ...
                    char mensaje = /*JR init for inni*/ '\0';
                    // Receive
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_charTovoid = JRget_op_puedoProducir_charTovoid().recv();
                        mensaje = (Character) recv_charTovoid.JRargs[0];
                        jrvm.ariseAndReceive();
                        if (recv_charTovoid.retOp != null)
                            recv_charTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    // End Receive
                    ...
                    JRget_op_puedoConsumir_charTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {mensaje});
                }
            }
        } catch (Exception JRe)    {
    ...
    static {
        try {
            for (int i = 0; i < p; i++) {
                op_Producer_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_Consumer_intTovoid()
    {
        return op_Consumer_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_Consumer_intTovoid;
    static class ProcOp_intTovoid_implConsumer extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implConsumer(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.ConsumerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.ConsumerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_Consumer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implConsumer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void ConsumerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Consumer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void ConsumerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop2: while (true) {
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_charTovoid = JRget_op_puedoConsumir_charTovoid().recv();
                        mensaje = (Character) recv_charTovoid.JRargs[0];
                        jrvm.ariseAndReceive();
                        if (recv_charTovoid.retOp != null)
                            recv_charTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    ...
                    // Begin Expr2
                    mensaje = '\000';
                    JRget_op_puedoProducir_charTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {mensaje});
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    static {
        try {
            for (int i = 0; i < c; i++) {
                op_Consumer_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_Consumer_intTovoid, op_Producer_intTovoid, op_puedoProducir_charTovoid, op_puedoConsumir_charTovoid);
    	this.JRcalled = true;
    }
