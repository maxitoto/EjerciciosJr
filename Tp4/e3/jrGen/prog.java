...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_mailbox_booleanTovoid()
    {
        return op_mailbox_booleanTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mailbox_booleanTovoid;
    ;
    static    {
        try    {
            op_mailbox_booleanTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static {
        JRget_op_mailbox_booleanTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {false});
    }
    
    static boolean testAndSet() {
        boolean mensaje = /*JR init for inni*/ false;
        // Receive
        {
            jrvm.sendAndDie();
            Recv_ext recv_booleanTovoid = JRget_op_mailbox_booleanTovoid().recv();
            mensaje = (Boolean) recv_booleanTovoid.JRargs[0];
            jrvm.ariseAndReceive();
            if (recv_booleanTovoid.retOp != null)
                recv_booleanTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
        }
        // End Receive
        
        JRget_op_mailbox_booleanTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {true});
        // Return
        return (mensaje);
        // End Return

    }
    static Op_ext.JRProxyOp JRget_op_p_intTovoid()
    {
        return op_p_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_p_intTovoid;
    static class ProcOp_intTovoid_implp extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implp(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.pintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.pintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_p_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implp(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void pintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_p_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void pintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 0; i < 3; i++) {
                op_p_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_p_intTovoid, op_mailbox_booleanTovoid);
    	this.JRcalled = true;
    }
