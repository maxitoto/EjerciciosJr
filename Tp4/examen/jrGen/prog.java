...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_autocruzaNorteAsur_intTovoid()
    {
        return op_autocruzaNorteAsur_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_autocruzaNorteAsur_intTovoid;
    static class ProcOp_intTovoid_implautocruzaNorteAsur extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implautocruzaNorteAsur(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.autocruzaNorteAsurintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.autocruzaNorteAsurintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_autocruzaNorteAsur_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implautocruzaNorteAsur(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void autocruzaNorteAsurintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_autocruzaNorteAsur_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void autocruzaNorteAsurintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                monitor.cruzar(0);
                // Begin Expr2
                System.out.println("auto " + i + " cruza desde el norte hacia el sur");
                // Begin Expr2
                monitor.liberar(0);
                // Return
                { if (retOp != null)
    ...
    static {
        try {
            for (int i = 0; i < 20; i++) {
                op_autocruzaNorteAsur_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_autocruzaSurAnorte_intTovoid()
    {
        return op_autocruzaSurAnorte_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_autocruzaSurAnorte_intTovoid;
    static class ProcOp_intTovoid_implautocruzaSurAnorte extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implautocruzaSurAnorte(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.autocruzaSurAnorteintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.autocruzaSurAnorteintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_autocruzaSurAnorte_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implautocruzaSurAnorte(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void autocruzaSurAnorteintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_autocruzaSurAnorte_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void autocruzaSurAnorteintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                monitor.cruzar(1);
                // Begin Expr2
                System.out.println("auto " + i + " cruza desde el sur hacia el norte");
                // Begin Expr2
                monitor.liberar(1);
                // Return
                { if (retOp != null)
    ...
    static {
        try {
            for (int i = 0; i < 10; i++) {
                op_autocruzaSurAnorte_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_autocruzaSurAnorte_intTovoid, op_autocruzaNorteAsur_intTovoid);
    	this.JRcalled = true;
    }
