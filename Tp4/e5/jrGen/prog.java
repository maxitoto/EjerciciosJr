...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_proceos_intTovoid()
    {
        return op_proceos_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_proceos_intTovoid;
    static class ProcOp_intTovoid_implproceos extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implproceos(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.proceosintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.proceosintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_proceos_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implproceos(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void proceosintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_proceos_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void proceosintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                String signal = /*JR init for inni*/ null;
                // Receive
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_javadotlangdotStringTovoid = JRget_op_mutex_javadotlangdotStringTovoid().recv();
                    signal = (java.lang.String) recv_javadotlangdotStringTovoid.JRargs[0];
                ...
                JRget_op_mutex_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {signal});
                // Return
                { if (retOp != null)
    ...
    static {
        try {
            for (int i = 0; i < p; i++) {
                op_proceos_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_proceos_intTovoid, op_mutex_javadotlangdotStringTovoid);
    	this.JRcalled = true;
    }
