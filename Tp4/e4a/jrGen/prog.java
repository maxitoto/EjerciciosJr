...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_Producer_voidTovoid()
    {
        return op_Producer_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_Producer_voidTovoid;
    static class ProcOp_voidTovoid_implProducer extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implProducer(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.ProducervoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.ProducervoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_Producer_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implProducer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void ProducervoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Producer_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void ProducervoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop1: while (true) {
                    ...
                    // Begin Expr2
                    System.out.println("Productor produjo " + mensaje);
    ...
    static Op_ext.JRProxyOp JRget_op_Consumer_voidTovoid()
    {
        return op_Consumer_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_Consumer_voidTovoid;
    static class ProcOp_voidTovoid_implConsumer extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implConsumer(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.ConsumervoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.ConsumervoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_Consumer_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implConsumer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void ConsumervoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_Consumer_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void ConsumervoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop2: while (true) {
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_Consumer_voidTovoid, op_Producer_voidTovoid, op_puedoProducir_charTovoid, op_puedoConsumir_charTovoid);
    	this.JRcalled = true;
    }
