...
return null;
    ...
    static boolean testandsetintToboolean(java.lang.Object [] JRargs) {
        return (Boolean)((Op_ext_.JRProxyOp)op_testandset_intToboolean).call(jrvm.getTimestamp(), JRargs);
    }
    private static boolean testandsetintToboolean(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int m = ((Number) JRargs[0]).intValue();
            {
                {
                    jrvm.sendAndDie();
                ...
                if (m == 0) {
                    ...
                    // Return
                    { if (retOp != null)
                        retOp.send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {(boolean)(true)});
                    else {
                    ...
                    // Return
                    { if (retOp != null)
                        retOp.send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {(boolean)(false)});
                    else {
    ...
    static Op_ext.JRProxyOp JRget_op_testandset_intToboolean()
    {
        return op_testandset_intToboolean;
    }
    
    public static Op_ext.JRProxyOp op_testandset_intToboolean;
    static class ProcOp_intToboolean_impltestandset extends ProcOp_ext_impl
    {
        public ProcOp_intToboolean_impltestandset(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                return prog.testandsetintToboolean(null, null, null, JRargs);
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.testandsetintToboolean(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
        ...
        public Cap_ext cosend(long JRtimestamp, Op_ext.JRProxyOp retOp, edu.ucdavis.jr.RemoteHandler handler, Exception thrown, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            Op_ext.JRProxyOp myretOp = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            myretOp.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            return new Cap_ext_(myretOp, "boolean");
        }
        public Cap_ext cocall(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            Op_ext.JRProxyOp retOp = new Op_ext_.JRProxyOp(new InOp_ext_impl(false));
            ...
            jrvm.threadBirth();
            new Thread(new sendThread(retOp, null, JRargs)).start();
            Cap_ext retCap = new Cap_ext_(retOp, "boolean");
            return retCap;
        }
        public Cap_ext cocall(long JRtimestamp, edu.ucdavis.jr.RemoteHandler handler, Cap_ext fretOp, java.lang.Object [] JRargs) throws RemoteException
        {
    ...
    static    {
        try    {
            op_testandset_intToboolean = new Op_ext_.JRProxyOp(new ProcOp_intToboolean_impltestandset(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
...
return null;
    ...
    private static void p1voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop1: while (true) {
                    JRLoop0: while (!((Boolean) (new Cap_ext_(JRget_op_testandset_intToboolean(), "boolean")).call(jrvm.getTimestamp(), new java.lang.Object [] {m}))) ;
                    // Begin Expr2
...
return null;
    ...
    private static void p2voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop3: while (true) {
                    JRLoop2: while (!((Boolean) (new Cap_ext_(JRget_op_testandset_intToboolean(), "boolean")).call(jrvm.getTimestamp(), new java.lang.Object [] {m}))) ;
                    // Begin Expr2
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_p2_voidTovoid, op_p1_voidTovoid, op_testandset_intToboolean, op_espera_intTovoid, op_x_voidTovoid);
    	this.JRcalled = true;
    }
