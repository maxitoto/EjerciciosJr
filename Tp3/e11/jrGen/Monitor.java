...
class Monitor extends java.lang.Object {
    ...
    private int recursosNoAsignados = recursosTotales;
    private int recursosAsigandos = 0;
    private m_condvar recursosDisponibles = new m_condvar("recursosDisponibles");
    
    public void solicitarRecursos(int i) {
    ...
    public void devolverRecursos(int i) {
        Op_ext.JRProxyOp op_m_return_from_wait_voidTovoid = null;
        try{
            op_m_return_from_wait_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError("Cannot initialize op"); }
        ...
        {
            if (((Boolean) (new Cap_ext_((recursosDisponibles).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null))) {
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = op_m_mutex_voidTovoid.recv();
                    jrvm.ariseAndReceive();
