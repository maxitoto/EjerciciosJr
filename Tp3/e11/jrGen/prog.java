...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_procesos_intTovoid()
    {
        return op_procesos_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_procesos_intTovoid;
    static class ProcOp_intTovoid_implprocesos extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implprocesos(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.procesosintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.procesosintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_procesos_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implprocesos(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void procesosintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_procesos_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void procesosintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 0; i < m; i++) {
                op_procesos_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_procesos_intTovoid);
    	this.JRcalled = true;
    }
