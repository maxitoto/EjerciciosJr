...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_barbero_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implbarbero(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.barberointTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.barberointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static void barberointTovoid(java.lang.Object [] JRargs) {
    ...
    private static void barberointTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop10: while (true) {
                    // Begin Expr2
                    monitor.duermeOtrabaja();
                    // Begin Expr2
                    monitor.cortarPelo();
                    // Begin Expr2
                    monitor.cobrarAlCliente();
                }
            }
        } catch (Exception JRe)    {
    ...
    static {
        try {
            for (int i = 0; i < b; i++) {
                op_barbero_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
...
return null;
    ...
    private static void clientesintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                monitor.ingresar();
                // Begin Expr2
                monitor.seCortaElPelo();
                // Begin Expr2
                monitor.pagaAlBarebero();
                // Begin Expr2
                monitor.seVa();
                // Return
                { if (retOp != null)
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_clientes_intTovoid, op_barbero_intTovoid);
    	this.JRcalled = true;
    }
