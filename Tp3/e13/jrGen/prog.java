...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_pocesos_intTovoid()
    {
        return op_pocesos_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_pocesos_intTovoid;
    static class ProcOp_intTovoid_implpocesos extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implpocesos(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.pocesosintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.pocesosintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_pocesos_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implpocesos(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void pocesosintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_pocesos_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void pocesosintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int Pid = ((Number) JRargs[0]).intValue();
            {
    ...
    static {
        try {
            for (int Pid = 0; Pid < p; Pid++) {
                op_pocesos_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {Pid});
            }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_pocesos_intTovoid);
    	this.JRcalled = true;
    }
