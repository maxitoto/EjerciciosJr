...
class miMonitor extends java.lang.Object {
    { JRinit(); }
    ...
    public String toString() {
        ...
        n++;
        {
            if (true) {
                ...
                m_next();
                // Return
                return ("soy el monitor numero " + n);
                // End Return
    ...
    protected JRmiMonitor jrresref;
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRmiMonitor(op_m_urgentq_voidTovoid, op_m_mutex_voidTovoid);
    	this.JRcalled = true;
    }
