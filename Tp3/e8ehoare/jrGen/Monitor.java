...
class Monitor extends java.lang.Object {
    ...
    public void producir(int id) {
        ...
        frente = (frente + 1) % n;
        // Begin Expr2
        System.out.println("productor " + id + " produce en indx:" + frente);
        // Begin Expr2
        cantElement += 1;
        {
            if (((Boolean) (new Cap_ext_((sellene).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null))) {
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = op_m_mutex_voidTovoid.recv();
                    jrvm.ariseAndReceive();
    ...
    public void consumir(int id) {
        ...
        cantElement -= 1;
        {
            if (((Boolean) (new Cap_ext_((sevacie).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null))) {
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = op_m_mutex_voidTovoid.recv();
                    jrvm.ariseAndReceive();
