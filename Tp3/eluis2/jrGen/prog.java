...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_agente_voidTovoid()
    {
        return op_agente_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_agente_voidTovoid;
    static class ProcOp_voidTovoid_implagente extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implagente(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.agentevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.agentevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_agente_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implagente(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void agentevoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_agente_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void agentevoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop7: while (true) {
    ...
    static {
        try {
            op_agente_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_fumador_intTovoid()
    {
        return op_fumador_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_fumador_intTovoid;
    static class ProcOp_intTovoid_implfumador extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implfumador(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.fumadorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.fumadorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_fumador_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implfumador(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void fumadorintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_fumador_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void fumadorintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 1; i < 4; i++) {
                op_fumador_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_fumador_intTovoid, op_agente_voidTovoid);
    	this.JRcalled = true;
    }
