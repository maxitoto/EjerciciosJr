...
class Monitor extends java.lang.Object {
    ...
    private boolean noPedirIngredientes = true;
    private m_condvar ponerIngredientes = new m_condvar("ponerIngredientes");
    private boolean nadiequiereIng = false;
    ...
    public void colocarIngredientes() {
        ...
        // Begin Expr2
        (new Cap_ext_((pongaIngredientes).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        // Begin Expr2
        m_next();
    }
    ...
    public boolean comprobarMesa(int id) {
        ...
        JRLoop6: while (noPedirIngredientes) {
            {
        ...
        if (id == 1 & mesa[0] == ingredientes[0] & mesa[1] == ingredientes[1]) {
            {
                if (true) {
                    // Begin Expr2
                    m_next();
            ...
            if (id == 2 & mesa[0] == ingredientes[0] & mesa[1] == ingredientes[2]) {
                {
                    if (true) {
                        // Begin Expr2
                        m_next();
                ...
                if (id == 3 & mesa[0] == ingredientes[1] & mesa[1] == ingredientes[2]) {
                    {
                        if (true) {
                            // Begin Expr2
                            m_next();
    ...
    public void fumar(int id) {
        ...
        // Begin Expr2
        (new Cap_ext_((ponerIngredientes).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        // Begin Expr2
        m_next();
    }
