...
class Monitor extends java.lang.Object {
    ...
    public void escribir(int id) {
        ...
        if (cantLectoresEsperando > 0 & cantEscritoresEscribiendo == 0) {
            // Begin Expr2
            (new Cap_ext_((esperandoLeer).JRget_op_m_signal_all_voidTovoid(), "void")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        } else {
    ...
    public int leer(int id) {
        ...
        JRLoop5: while (cantEscritoresEscribiendo == 1) {
            // Begin Expr2
