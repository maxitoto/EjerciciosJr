...
class Monitor extends java.lang.Object {
    ...
    public void escribir(int id) {
        ...
        // Begin Expr2
        System.out.println(" Escritor " + id + "dice{" + " lect leyendo: " + cantLectoresLeyendo + " lect esperando: " + cantLectoresEsperando + " escr escribiendo: " + cantEscritoresEscribiendo + " escr esperando: " + cantEscritoresEsperando + "}");
        // Begin Expr2
        cantEscritoresEscribiendo--;
        if (cantLectoresEsperando == 0) {
            {
                if (((Boolean) (new Cap_ext_((esperandoEscribir).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null))) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = op_m_mutex_voidTovoid.recv();
                        jrvm.ariseAndReceive();
            ...
            JRLoop5: for (int j = 0; j < cantLectoresEsperando; j++) {
                {
                    if (((Boolean) (new Cap_ext_((esperandoLeer).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null))) {
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = op_m_mutex_voidTovoid.recv();
                            jrvm.ariseAndReceive();
    ...
    public int leer(int id) {
        ...
        cantLectoresLeyendo++;
        // Begin Expr2
        System.out.println(" lector " + id + "dice{" + " lect leyendo: " + cantLectoresLeyendo + " lect esperando: " + cantLectoresEsperando + " escr escribiendo: " + cantEscritoresEscribiendo + " escr esperando: " + cantEscritoresEsperando + "}");
        {
            if (true) {
                // Begin Expr2
                m_next();
