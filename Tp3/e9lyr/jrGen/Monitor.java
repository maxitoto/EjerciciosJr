...
class Monitor extends java.lang.Object {
    ...
    public void producir(int id) {
        ...
        cantElement += 1;
        // Begin Expr2
        (new Cap_ext_((sellene).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        // Begin Expr2
        m_next();
    }
    ...
    public void consumir(int id) {
        ...
        cantElement -= 1;
        // Begin Expr2
        (new Cap_ext_((sevacie).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        // Begin Expr2
        m_next();
    }
