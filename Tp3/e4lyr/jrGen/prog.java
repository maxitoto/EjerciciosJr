...
public class prog extends java.lang.Object {
    ...
    static {
        // Begin Expr2
        monitor = new Monitor("Monitor LyR");
    }
    ...
    static Op_ext.JRProxyOp JRget_op_escritores_intTovoid()
    {
...
return null;
    ...
    static void escritoresintTovoid(java.lang.Object [] JRargs) {
    ...
    static Op_ext.JRProxyOp JRget_op_lectrores_intTovoid()
    {
        return op_lectrores_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_lectrores_intTovoid;
    static class ProcOp_intTovoid_impllectrores extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_impllectrores(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.lectroresintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.lectroresintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_lectrores_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_impllectrores(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void lectroresintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_lectrores_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void lectroresintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
    ...
    static {
        try {
            for (int i = 0; i < l; i++) {
                op_lectrores_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_lectrores_intTovoid, op_escritores_intTovoid);
    	this.JRcalled = true;
    }
