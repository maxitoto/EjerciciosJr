...
class Puente extends java.lang.Object {
    { JRinit(); }
    ...
    public void entrar_lado_A() {
        ...
        JRLoop4: while (!turnoA || turnoCount > N) {
            // Begin Expr2
    ...
    public void entrar_lado_B() {
        ...
        JRLoop5: while (turnoA || turnoCount > N) {
            // Begin Expr2
    ...
    public void salir() {
        ...
        if (turnoA) {
            ...
            // Begin Expr2
            (new Cap_ext_((CanalA).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        } else {
            // Begin Expr2
            ...
            // Begin Expr2
            (new Cap_ext_((CanalB).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
        }
        // Begin Expr2
        System.out.println("====================");
        // Begin Expr2
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRPuente(op_m_urgentq_voidTovoid, op_m_mutex_voidTovoid);
    	this.JRcalled = true;
    }
