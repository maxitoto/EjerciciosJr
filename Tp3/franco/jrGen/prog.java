...
public class prog extends java.lang.Object {
    ...
    private static Puente puente = new Puente("Monitor Puente");
    
    public static void main(String... args) {
    }
    private static Op_ext.JRProxyOp JRget_op_VehiculoLadoA_intTovoid()
    {
        return op_VehiculoLadoA_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_VehiculoLadoA_intTovoid;
    static class ProcOp_intTovoid_implVehiculoLadoA extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implVehiculoLadoA(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.VehiculoLadoAintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.VehiculoLadoAintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_VehiculoLadoA_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implVehiculoLadoA(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void VehiculoLadoAintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_VehiculoLadoA_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void VehiculoLadoAintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 0; i < N; i++) {
                op_VehiculoLadoA_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_VehiculoLadoB_intTovoid()
    {
        return op_VehiculoLadoB_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_VehiculoLadoB_intTovoid;
    static class ProcOp_intTovoid_implVehiculoLadoB extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implVehiculoLadoB(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.VehiculoLadoBintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.VehiculoLadoBintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_VehiculoLadoB_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implVehiculoLadoB(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void VehiculoLadoBintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_VehiculoLadoB_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void VehiculoLadoBintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
    ...
    static {
        try {
            for (int i = 0; i < N; i++) {
                op_VehiculoLadoB_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_VehiculoLadoB_intTovoid, op_VehiculoLadoA_intTovoid);
    	this.JRcalled = true;
    }
