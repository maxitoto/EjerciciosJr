...
public class prog extends java.lang.Object {
    ...
    static Monitor monitor = new Monitor("L&R");
    static int consultorioUsado = -1;
    static Op_ext.JRProxyOp JRget_op_recepcionista_voidTovoid()
    {
        return op_recepcionista_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_recepcionista_voidTovoid;
    static class ProcOp_voidTovoid_implrecepcionista extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implrecepcionista(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.recepcionistavoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.recepcionistavoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_recepcionista_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implrecepcionista(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void recepcionistavoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_recepcionista_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void recepcionistavoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop9: while (true) {
                    // Begin Expr2
                    monitor.asignarPacienteAConsultorio();
                }
            }
        } catch (Exception JRe)    {
    ...
    static {
        try {
            op_recepcionista_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_paciente_intTovoid()
    {
        return op_paciente_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_paciente_intTovoid;
    static class ProcOp_intTovoid_implpaciente extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implpaciente(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.pacienteintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.pacienteintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_paciente_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implpaciente(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void pacienteintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_paciente_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void pacienteintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop10: while (true) {
                    // Begin Expr2
                    consultorioUsado = monitor.asignarPacienteAConsultorio();
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    static {
        try {
            for (int i = 0; i < 20; i++) {
                op_paciente_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_medico_intTovoid()
    {
        return op_medico_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_medico_intTovoid;
    static class ProcOp_intTovoid_implmedico extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implmedico(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.medicointTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.medicointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_medico_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implmedico(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void medicointTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_medico_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void medicointTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop11: while (true) {
                    ...
                    monitor.atender();
                    // Begin Expr2
                    System.out.println("Medico atiende");
                    // Begin Expr2
                    monitor.liberarConsultorio(consultorioUsado);
                    // Begin Expr2
                    System.out.println("consultorio liberado " + consultorioUsado);
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    static {
        try {
            for (int i = 0; i < 3; i++) {
                op_medico_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_medico_intTovoid, op_paciente_intTovoid, op_recepcionista_voidTovoid);
    	this.JRcalled = true;
    }
