...
public class ReadWrite extends java.lang.Object {
    { JRinit(); }
    ...
    private static Op_ext.JRProxyOp JRget_op_reader_intTovoid()
    {
        return op_reader_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_reader_intTovoid;
    static class ProcOp_intTovoid_implreader extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implreader(ReadWrite thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                ReadWrite.readerintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ReadWrite.readerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_reader_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implreader(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void readerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_reader_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void readerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 0; i < 50; i++) {
                op_reader_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_writer_intTovoid()
    {
        return op_writer_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_writer_intTovoid;
    static class ProcOp_intTovoid_implwriter extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implwriter(ReadWrite thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ReadWrite.writerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ReadWrite.writerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_writer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implwriter(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void writerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_writer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void writerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
    ...
    static {
        try {
            for (int i = 0; i < 50; i++) {
                op_writer_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    {
        public ProcOp_voidTovoid_impldone(ReadWrite thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ReadWrite.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ReadWrite.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    {
        public ProcOp_intTovoid_implpausa(ReadWrite thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ReadWrite.pausaintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ReadWrite.pausaintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRReadWrite jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRReadWrite(op_pausa_intTovoid, op_done_voidTovoid, op_writer_intTovoid, op_reader_intTovoid);
    	this.JRcalled = true;
    }
