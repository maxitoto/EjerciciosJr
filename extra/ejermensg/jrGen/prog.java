...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_espacioDisponible_javadotlangdotStringTovoid()
    {
        return op_espacioDisponible_javadotlangdotStringTovoid;
    }
    
    public static Op_ext.JRProxyOp op_espacioDisponible_javadotlangdotStringTovoid;
    ;
    static    {
        try    {
            op_espacioDisponible_javadotlangdotStringTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_puerta_javadotlangdotStringTovoid()
    {
        return op_puerta_javadotlangdotStringTovoid;
    }
    
    public static Op_ext.JRProxyOp op_puerta_javadotlangdotStringTovoid;
    ;
    static    {
        try    {
            op_puerta_javadotlangdotStringTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static boolean p1lleno = false;
    static int contp1 = 0;
    static int contpb = 0;
    static boolean pblleno = false;
    static {
        JRLoop0: for (int i = 0; i < espacio * 2; i++) {
            JRget_op_espacioDisponible_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {""});
        }
        JRget_op_puerta_javadotlangdotStringTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {""});
    }
    
    static void esperavoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_espera_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void esperavoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                try {
    ...
    static class ProcOp_voidTovoid_implespera extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implespera(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.esperavoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.esperavoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_espera_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implespera(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static Op_ext.JRProxyOp JRget_op_auto_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implauto(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.autointTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.autointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static void autointTovoid(java.lang.Object [] JRargs) {
    ...
    private static void autointTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_javadotlangdotStringTovoid = JRget_op_puerta_javadotlangdotStringTovoid().recv();
                ...
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_javadotlangdotStringTovoid = JRget_op_espacioDisponible_javadotlangdotStringTovoid().recv();
                    mensaje = (java.lang.String) recv_javadotlangdotStringTovoid.JRargs[0];
                    jrvm.ariseAndReceive();
                    if (recv_javadotlangdotStringTovoid.retOp != null)
                        recv_javadotlangdotStringTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                ...
                if (contpb < espacio) {
                    ...
                    // Begin Expr2
                    (new Cap_ext_(JRget_op_espera_voidTovoid(), "void")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    // Begin Expr2
                    contpb--;
                    // Begin Expr2
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_auto_intTovoid, op_espera_voidTovoid, op_puerta_javadotlangdotStringTovoid, op_espacioDisponible_javadotlangdotStringTovoid);
    	this.JRcalled = true;
    }
