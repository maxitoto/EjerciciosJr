...
public class prog extends java.lang.Object {
    ...
    static Op_ext.JRProxyOp JRget_op_deNorteASur_intTovoid()
    {
        return op_deNorteASur_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_deNorteASur_intTovoid;
    static class ProcOp_intTovoid_impldeNorteASur extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_impldeNorteASur(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                prog.deNorteASurintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.deNorteASurintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_deNorteASur_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_impldeNorteASur(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void deNorteASurintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_deNorteASur_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void deNorteASurintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 0; i < aN; i++) {
                op_deNorteASur_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    static Op_ext.JRProxyOp JRget_op_deSurANorte_intTovoid()
    {
        return op_deSurANorte_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_deSurANorte_intTovoid;
    static class ProcOp_intTovoid_impldeSurANorte extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_impldeSurANorte(prog thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                prog.deSurANorteintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    prog.deSurANorteintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_deSurANorte_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_impldeSurANorte(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    static void deSurANorteintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_deSurANorte_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void deSurANorteintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
    ...
    static {
        try {
            for (int i = 0; i < aS; i++) {
                op_deSurANorte_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRprog(op_deSurANorte_intTovoid, op_deNorteASur_intTovoid);
    	this.JRcalled = true;
    }
