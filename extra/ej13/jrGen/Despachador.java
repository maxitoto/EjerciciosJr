...
class Despachador extends java.lang.Object {
    ...
    private boolean cpu_uno_libre = true;
    private boolean cpu_dos_libre = true;
    private m_condvar cpu = new m_condvar("cpu");
    private m_condvar wait_process = new m_condvar("wait_process");
    private int procesos_esperando = 0;
    private int procesos_asignados = 0;
    
    public void asignar_proceso(int cpu_id) {
    ...
    public void terminar_proceso(int cpu_id) {
        Op_ext.JRProxyOp op_m_return_from_wait_voidTovoid = null;
        try{
            op_m_return_from_wait_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError("Cannot initialize op"); }
    ...
    public void adquirir_cpu() {
        ...
        if (cpu_uno_libre) {
            ...
            cpu_uno_libre = false;
            {
                // Begin Expr2
                m_n_urgentq++;
                if (((Boolean) (new Cap_ext_((wait_process).JRget_op_m_signal_voidToboolean(), "boolean")).call(jrvm.getTimestamp(), (java.lang.Object[]) null))) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = op_m_urgentq_voidTovoid.recv();
                        jrvm.ariseAndReceive();
    ...
    public void get_procesos_asignados() {
        Op_ext.JRProxyOp op_m_return_from_wait_voidTovoid = null;
        try{
            op_m_return_from_wait_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
        } catch (Exception e) { throw new jrRuntimeError("Cannot initialize op"); }
