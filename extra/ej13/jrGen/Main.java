...
public class Main extends java.lang.Object {
    ...
    private static Op_ext.JRProxyOp JRget_op_cpu_uno_voidTovoid()
    {
        return op_cpu_uno_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_cpu_uno_voidTovoid;
    static class ProcOp_voidTovoid_implcpu_uno extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implcpu_uno(Main thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Main.cpu_unovoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Main.cpu_unovoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_cpu_uno_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implcpu_uno(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void cpu_unovoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_cpu_uno_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void cpu_unovoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop4: while (true) {
    ...
    static {
        try {
            op_cpu_uno_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_cpu_dos_voidTovoid()
    {
        return op_cpu_dos_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_cpu_dos_voidTovoid;
    static class ProcOp_voidTovoid_implcpu_dos extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implcpu_dos(Main thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Main.cpu_dosvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Main.cpu_dosvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_cpu_dos_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implcpu_dos(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void cpu_dosvoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_cpu_dos_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void cpu_dosvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop5: while (true) {
    ...
    static {
        try {
            op_cpu_dos_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_procesos_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implprocesos(Main thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Main.procesosintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Main.procesosintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void procesosintTovoid(java.lang.Object [] JRargs) {
    ...
    {
        public ProcOp_voidTovoid_impldone(Main thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Main.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Main.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRMain(op_done_voidTovoid, op_procesos_intTovoid, op_cpu_dos_voidTovoid, op_cpu_uno_voidTovoid);
    	this.JRcalled = true;
    }
